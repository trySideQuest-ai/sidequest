---
name: check
description: "Deprecated alias for /sidequest:sq-status. Forwards to the new name."
---

# /sidequest:check (alias)

This diagnostic command has moved to `/sidequest:sq-status` for naming clarity. Run `/sidequest:sq-status` instead.
